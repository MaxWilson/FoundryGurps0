...
[<assembly: AssemblyTitleAttribute("FoundryGurps0")>]
[<assembly: AssemblyProductAttribute("FoundryGurps0")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FoundryGurps0"
    let [<Literal>] AssemblyProduct = "FoundryGurps0"
